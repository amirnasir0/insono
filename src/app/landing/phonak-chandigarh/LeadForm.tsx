...
export default function LeadForm({
  ...
  return (
    ...
    >
      ...
      {/* UTM tracking */}
      <input type="hidden" name="utm_source" value={isMobile ? "phonak-chandigarh-mobile" : "phonak-chandigarh-landing"} />
      <input type="hidden" name="utm_medium" value={isMobile ? "Mobile" : "google-ads"} />
      <input type="hidden" name="utm_campaign" value="phonak-chandigarh-hearing-aids" />
