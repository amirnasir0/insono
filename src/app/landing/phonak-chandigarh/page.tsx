...
const CHANDIGARH_MODELS = [
  {
    ...
    waMessage: "Hi, I want to know about Phonak Audeo Sphere I90 in Chandigarh",
  },
  {
    rank: 2,
    badge: "Ultra Stylish",
    ...
    waMessage: "Hi, I want to know about Phonak Slim L90-R in Chandigarh",
  },
  {
    rank: 3,
    badge: "Best Seller",
  ...
  },
  {
    ...
    waMessage: "Hi, I want to know about Phonak Naida Lumity in Chandigarh",
  },
  {
    rank: 5,
    badge: "Great Value",
    ...
    waMessage: "Hi, I want to know about Phonak Terra in Chandigarh",
  },
];

const FAQS = [
  {
    q: "What is the price of Phonak hearing aids in Chandigarh?",
  ...
  {
    q: "Do you offer free Phonak trials in Chandigarh?",
    a: "Yes, we offer a 100% free clinical trial of the latest Phonak models at our Chandigarh clinic so you can experience the sound quality before you buy.",
  },
  {
    q: "Is Phonak Audeo Sphere available in Chandigarh?",
    a: "Yes! Insono is an authorized partner for the latest Phonak Sphere AI technology in Chandigarh. You can book a live demo at our clinic today.",
  },
  {
  ...
  },
  {
    ...
    a: "Phonak offers up to 4 years of international manufacturer warranty along with lifetime after-sales support at our Chandigarh center.",
  },
  {
    q: "Do you provide home visits for Phonak trials in Chandigarh?",
    a: "Yes, for senior citizens and those unable to travel, we provide home hearing tests and Phonak trials across Chandigarh, Mohali, and Panchkula.",
  },
];
      ...
      <div className="hidden md:block">
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.4em]">© 2026 Insono Hearing · Phonak Specialist Center · Chandigarh</p>
          </div>
        </footer>
      </div>
