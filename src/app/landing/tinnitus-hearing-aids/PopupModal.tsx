            ...
            <div className="px-6 pt-5 pb-6">
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  ...
                  <h2 className="text-[18px] font-black text-[#0D2240] leading-tight">
                    Download Tinnitus Hearing<br />Aid Price List 2026
                  </h2>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-4 mb-5 border border-slate-100">
                ...
                <ul className="space-y-2">
                  {[
                    "Signia Notch Therapy, Widex Zen & Phonak Tinnitus Balance",
                    "All model prices with EMI breakdown",
                    "Tinnitus masking feature comparison",
                    "Exclusive clinic discount & free trial offer",
                  ].map((item) => (
              ...
              <div className="flex items-center justify-center gap-4 mt-4">
                <Image src="/brands/signia.svg" alt="Signia" width={64} height={16} className="h-4 w-auto grayscale opacity-40" />
