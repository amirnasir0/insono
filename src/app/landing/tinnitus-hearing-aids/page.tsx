    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          <Link href="#">
            <Image src="/logo.webp" alt="Insono Hearing" width={100} height={32} className="h-8 w-auto" />
          </Link>
          <a
            href="https://wa.me/916204260510?text=Hi,%20I%20want%20to%20consult%20an%20audiologist%20about%20tinnitus."
            className="flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-[#128C7E] transition shadow-md"
          >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 sm:hidden bg-white border-t border-gray-200 shadow-2xl px-4 py-3 flex gap-3">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 border-2 border-[#023784] text-[#023784] py-3 rounded-2xl font-black text-sm"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          href="#lead-form"
          className="flex-[2] flex items-center justify-center gap-2 bg-[#023784] text-white py-3 rounded-2xl font-black text-sm shadow-lg shadow-blue-900/20"
        >
          Download Price List
        </a>
      </div>
