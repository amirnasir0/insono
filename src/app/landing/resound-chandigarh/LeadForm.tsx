...
export default function LeadForm({
  ...
  return (
    ...
    >
      ...
      {/* UTM tracking */}
      <input type="hidden" name="utm_source" value={isMobile ? "resound-chandigarh-mobile" : "resound-chandigarh-landing"} />
      <input type="hidden" name="utm_medium" value={isMobile ? "Mobile" : "google-ads"} />
      <input type="hidden" name="utm_campaign" value="resound-chandigarh-hearing-aids" />
