...
const CHANDIGARH_MODELS = [
  {
    ...
    features: ["Bluetooth Auracast", "Organic Hearing", "Rechargeable", "Speech Clarity"],
    channels: "17 Channels",
    style: "RIC",
    highlight: "The industry's first hearing aid ready for the next generation of Bluetooth",
  },
  {
    rank: 2,
    badge: "Best in Noise",
    ...
    brand: "ReSound",
    brandLogo: "/brands/resound.svg",
    image: "/lp/resound2.png",
    features: ["150% Speech Improvement", "Natural Sound", "All-Day Battery", "App Control"],
    channels: "17 Channels",
    style: "RIC",
    highlight: "Designed specifically to help you hear 150% better in noisy environments",
  },
  {
    rank: 3,
    badge: "Organic Hearing",
    badgeColor: "bg-purple-600 text-white",
    title: "ReSound ONE",
    brand: "ReSound",
    brandLogo: "/brands/resound.svg",
    image: "/lp/resound3.png",
    features: ["M&RIE Technology", "3 Mic System", "Ultra Focus", "Direct Streaming"],
    channels: "17 Channels",
    style: "RIC",
    highlight: "Uses the unique shape of your ear to deliver the most organic sound",
  },
  {
    rank: 4,
    badge: "Premium RIC",
    badgeColor: "bg-rose-600 text-white",
    title: "ReSound LiNX Quattro",
    brand: "ReSound",
    brandLogo: "/brands/resound.svg",
    image: "/lp/resound4.png",
    features: ["High Dynamic Range", "Streaming for iOS/Android", "Fast Charge", "Clear Sound"],
    channels: "14 Channels",
    style: "RIC",
    highlight: "A premium solution for those who want clear, distortion-free sound",
  },
  {
    rank: 5,
    badge: "Essential",
    ...
    brandLogo: "/brands/resound.svg",
    image: "/lp/resound1.png",
    features: ["Natural Soundscape", "Bluetooth Streaming", "Reliable Build", "Affordable"],
    channels: "12 Channels",
    style: "BTE/RIC",
    highlight: "The key to better hearing—reliable technology at an affordable price",
  },
];
...
const REVIEWS = [
  {
    ...
    time: "3 weeks ago",
    text: "The ReSound Nexia connectivity is flawless. I can stream my calls and music directly with crystal clarity. Highly impressed with Insono's professional approach.",
  },
  {
    name: "Gurdev Singh",
    initials: "GS",
    ...
    location: "Mohali",
    time: "2 months ago",
    text: "Switched to ReSound OMNIA and the difference in noise is huge. I can finally hear my family at the dinner table. Excellent clinic and staff in Chandigarh.",
  },
  {
    name: "Suman Dhillon",
    initials: "SD",
    ...
    location: "Panchkula",
    time: "1 month ago",
    text: "Got ReSound ONE for my mother. The 'Organic Hearing' technology really works. She feels the sound is much more natural now. Highly recommended.",
  },
  {
    name: "Puneet Sharma",
    initials: "PS",
    ...
    location: "Chandigarh",
    time: "2 weeks ago",
    text: "Best price for ReSound in Chandigarh. Transparent process and very helpful audiologists. The 7-day trial helped me make the right decision.",
  },
];
...
export default function ResoundChandigarhPage() {
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-[#eaf5ff]">
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          .rc-up            { animation: rc-up    0.5s ease both; }
          .rc-up.d1         { animation-delay: 0.1s; }
          .rc-up.d2         { animation-delay: 0.2s; }
          .rc-up.d3         { animation-delay: 0.3s; }
          .rc-up.d4         { animation-delay: 0.4s; }
          .rc-left          { animation: rc-left  0.5s ease both; }
          .rc-scale         { animation: rc-scale 0.8s 0.5s ease both; }
        `
      }} />
      ...
      <div className="block md:hidden pb-20">
        ...
        <section className="bg-gradient-to-b from-[#eaf5ff] to-white relative overflow-hidden">
          <div className="px-4 pt-3 pb-10 relative z-10 text-center">
            <h1 className="rc-up text-[22px] font-black leading-[1.15] mb-5 tracking-tight">
            ...
            <div className="rc-up d1 relative w-full mb-5 flex flex-col items-center justify-center">
              <div className="absolute w-[140px] h-[140px] bg-[#184A99]/8 rounded-full blur-[40px]" />
              <Image
                src="/lp/resound1.png"
                alt="ReSound Digital Hearing Aid"
                width={180}
                height={180}
            ...
            <ul className="rc-up d2 space-y-3 mb-6 text-left">
              {[
                { icon: "🔊", text: "Organic Hearing & Smart Connectivity" },
                { icon: "🏥", text: "Free Hearing Test at Chandigarh Clinic" },
                { icon: "💰", text: "Save upto ₹31,500 on ReSound Aids" },
              ].map((b) => (
        ...
        <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.1)] border-t border-slate-100 custom-bottom-bar flex">
          <a
            href="https://wa.me/916204260510?text=Hi, I want to chat with an audiologist about ReSound hearing aids in Chandigarh"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <div className="max-w-6xl mx-auto px-6 pt-10">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="flex-[1.6] pt-8">
                <div className="rc-left hidden lg:inline-flex items-center gap-2 bg-[#184A99]/10 rounded-full px-5 py-2 text-[11px] font-bold text-[#184A99] mb-8 border border-[#184A99]/20">
                  <span className="w-2 h-2 bg-[#184A99] rounded-full animate-pulse" />
                  Authorized Partner · Expert Audiologists in Chandigarh
                </div>

                <h1 className="rc-up d1 text-5xl lg:text-[52px] font-black leading-[1.15] mb-8 text-[#0D2240] tracking-tight">
                  <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                    ReSound Digital Hearing Aids Price 2026
                  </span>
                </h1>

                <p className="rc-up d2 text-slate-500 text-xl mb-12 max-w-xl leading-relaxed font-medium">
                  Discover the{" "}
                ...
                <div className="rc-up d3 grid grid-cols-3 gap-8 pt-10 border-t border-slate-100 mb-12">
                  {[
                ...
                <div className="rc-up d4 pt-8 border-t border-slate-100 opacity-60">
              ...
              {/* Col 2: Hero image */}
              <div className="rc-scale hidden xl:flex flex-1 justify-center relative group py-20">
                ...
                <Image
                  src="/lp/resound1.png"
                  alt="Premium ReSound Hearing Aids"
                  width={500}
                  height={500}
                  sizes="500px"
              ...
              {/* Col 3: Lead form */}
              <div className="rc-up d4 w-full lg:w-[380px] flex-shrink-0 pt-8">
                <div id="lead-form" className="bg-white rounded-[2.5rem] shadow-2xl p-10 text-slate-900 relative overflow-hidden border border-slate-50">
                  ...
                  <h2 className="text-2xl font-bold mb-3 pt-4 text-[#0D2240]">Download ReSound Prices &amp; Claim Free Trial</h2>
                  <p className="text-slate-500 text-xs mb-8 leading-relaxed">Get the full 2026 ReSound Price List instantly on WhatsApp.</p>
                  <LeadForm />
                </div>
              </div>
            </div>
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.4em]">
              © 2026 Insono Hearing · ReSound Specialist Center · Chandigarh
            </p>
          </div>
        </footer>
      </div>
