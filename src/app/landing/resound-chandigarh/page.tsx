...
const CHANDIGARH_MODELS = [
  ...
  },
  {
    ...
    waMessage: "Hi, I want to know about ReSound OMNIA in Chandigarh",
  },
  {
    rank: 3,
    ...
    waMessage: "Hi, I want to know about ReSound ONE in Chandigarh",
  },
  {
    rank: 4,
    badge: "Premium RIC",
    ...
    waMessage: "Hi, I want to know about ReSound LiNX Quattro in Chandigarh",
  },
  {
    rank: 5,
    badge: "Essential",
    ...
    waMessage: "Hi, I want to know about ReSound Key in Chandigarh",
  },
];
      ...
      <div className="hidden md:block">
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.4em]">© 2026 Insono Hearing · ReSound Specialist Center · Chandigarh</p>
          </div>
        </footer>
      </div>
              ...
              <div className="px-6 pt-5 pb-6">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <div className="flex-shrink-0 w-14 h-14 rounded-2xl overflow-hidden border border-slate-100 shadow-sm text-center flex items-center justify-center bg-slate-50">
                    <img src="/brands/resound.svg" alt="ReSound" className="w-10 h-auto grayscale" />
                  </div>
                  <div>
                    ...
                    <h2 className="text-[18px] font-black text-[#0D2240] leading-tight">
                      Download Complete<br />ReSound Price List 2026
                    </h2>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-4 mt-4">
                  <img src="/brands/resound.svg" alt="ReSound" className="h-4 w-auto grayscale opacity-40" />
