...
export const metadata: Metadata = {
  title: "Siemens (Signia) Hearing Aids Price in India 2026 — Book a Free Trial",
  description:
    "Discover the latest German-engineered Siemens (Signia) hearing aids. Rechargeable, AI-powered, and virtually invisible models. Get up to ₹31,500 off + 0% EMI options. Free trials in 450+ cities.",
};
...
const TOP5 = [
  {
    ...
    features: [
      "Virtually invisible in-ear custom design",
      "World's first rechargeable invisible model",
      "Enhances speech in noisy environments",
      "Instant fit with comfortable click sleeves",
      "Advanced binaural phone audio streaming",
    ],
    highlight: "German-engineered for absolute discretion and natural hearing.",
  },
  {
    rank: 2,
    badge: "Ultra Slim & Stylish",
    ...
    features: [
      "Award-winning sleek ergonomic profile",
      "Direct Bluetooth streaming to iOS & Android",
      "Dynamic soundscape sensors",
      "Pocket-sized portable charging case",
      "Crystal clear multi-speaker tracking",
    ],
    highlight: "Hearing technology meets premium aesthetic fashion.",
  },
  {
    rank: 3,
    badge: "Real-time speech AI",
    ...
    features: [
      "Real-time conversation tracking AI",
      "Long-lasting 28-hour rechargeable battery",
      "High-definition Bluetooth audio streaming",
      "Robust IP68 water & dust resistance",
      "Automatic sound landscape adaptation",
    ],
    highlight: "German engineering optimized for clear group conversations.",
  },
  {
    rank: 4,
    ...
    features: [
      "Modern earbud-style high-tech look",
      "Instant-fit sleeves for immediate wear",
      "Full Bluetooth music and call streaming",
      "Premium sound clarity in noisy environments",
      "Pocket-sized high capacity charging case",
    ],
    highlight: "Sleek and sporty alternative to traditional hearing aids.",
  },
  {
    rank: 5,
    badge: "Reliable Value",
    ...
    features: [
      ...
      "48 channels of precise sound control",
      "Automatic feedback prevention system",
      "Tinnitus therapy customized signals",
      "Sturdy, durable German housing design",
    ],
    highlight: "Premium digital performance and absolute reliability.",
  },
];
...
const REVIEWS = [
  {
    ...
    time: "1 month ago",
    location: "Delhi",
    text: "These Siemens/Signia hearing aids have transformed my mother's life. The speech clarity is outstanding even when multiple people talk in the room. Highly patient audiologist at Insono.",
  },
  {
    ...
    time: "2 months ago",
    location: "Kolkata",
    text: "Excellent service. Got a free hearing test and took a home trial of the invisible Signia Silk. Very transparent pricing and authentic devices. Highly recommended!",
  },
  {
    name: "Honey Kumar",
    initials: "HK",
    ...
    time: "3 months ago",
    location: "Mumbai",
    text: "Bought the rechargeable Pure C&G for my father. He can stream TV directly and hear mobile calls perfectly. Saving ₹30,000 on the pair was a massive bonus.",
  },
  {
    name: "Meena Verma",
    initials: "MV",
    ...
    time: "2 weeks ago",
    location: "Bangalore",
    text: "The Signia Styletto looks like high-end wireless earbuds and fits perfectly. The 7-day trial gave us complete confidence before buying. Insono makes it so easy.",
  },
];
...
export default function SiemensLandingPage() {
  return (
      ...
      <div className="block md:hidden pb-20">
        ...
        <div className="sticky top-0 z-50 t5-mobile-header-wrapper">
          <header className="px-4 py-3 flex items-center justify-between t5-mobile-header bg-white/90 backdrop-blur-sm border-b border-slate-100">
            <Link href="/landing/siemens-hearing-aid">
          ...
          <div className="px-4 pt-4 pb-8 relative z-10 text-center">
            ...
            <div className="t5-up d2 w-full mb-2">
              <PopupTrigger className="w-full h-[52px] bg-[#E83D6D] text-white flex items-center justify-center gap-2 rounded-xl text-[15px] font-black shadow-lg shadow-[#E83D6D]/30 active:scale-[0.97] transition-all">
                Get Siemens Price List on WhatsApp
            ...
            <p className="t5-up d2 text-[10px] text-slate-400 font-medium mb-5">
              Free · Instant on WhatsApp · No Spam Guarantee
            </p>
            ...
            <div className="t5-up d3 flex items-center justify-center gap-5 mb-7 grayscale opacity-40">
              ...
              <span className="text-slate-400 text-xs font-semibold">German Hearing Engineering Partner</span>
            </div>
            ...
            <div className="relative w-full mb-6 flex items-center justify-center">
              ...
              <Image
                src="/hero3.png"
                alt="German Siemens Signia Hearing Aids"
                width={180}
                height={160}
            ...
            <ul className="space-y-2.5 text-left">
              <li className="flex items-center gap-3 bg-slate-50 border border-slate-100 rounded-2xl px-4 py-3">
                ...
                <span className="text-[13px] font-semibold text-slate-700 leading-snug">World-renowned German engineering for peak speech clarity</span>
              </li>
              <li className="flex items-center gap-3 bg-slate-50 border border-slate-100 rounded-2xl px-4 py-3">
                <div className="w-9 h-9 rounded-xl bg-[#184A99]/10 flex items-center justify-center flex-shrink-0 text-lg">💰</div>
        ...
        <section className="py-8 px-4 bg-white">
          <div className="text-center mb-5">
            <h2 className="text-lg font-black text-slate-900">Latest Siemens (Signia) Models</h2>
              ...
              <div key={p.rank} className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex">
                ...
                <div className="flex-1 p-3 flex flex-col justify-between min-w-0">
                  <div>
                    ...
                    <p className="text-[9px] text-slate-500 font-medium mb-1">#{p.rank} Choice · Siemens Legacy</p>
                  </div>
              ...
              <div key={r.name} className="bg-slate-50 rounded-2xl border border-slate-100 p-4">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[9px] text-slate-400 mt-0.5">{r.location} · <span className="text-emerald-500 font-semibold">✓ Verified Partner</span></p>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.1)] border-t border-slate-100 t5-bottom-bar flex">
          <a
            href="https://wa.me/916204260510?text=Hi, I want to know about Siemens Signia hearing aids and pricing"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            ...
            <span className="text-[10px] font-black leading-none">Chat with Expert</span>
          </a>
          ...
          >
            ...
            <span className="text-[10px] font-black leading-none text-center">Call and Save Up to ₹31,500</span>
          </a>
        </div>
      </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
              ...
              <div className="flex-[1.2] pt-0">
                <div className="t5-left hidden lg:inline-flex items-center gap-2 bg-[#184A99]/10 rounded-full px-5 py-2 text-[11px] font-bold text-[#184A99] mb-8 border border-[#184A99]/20">
                  ...
                  Authorized Siemens &amp; Signia Partner · Trusted across India
                </div>
                ...
                <p className="t5-up d2 text-slate-500 text-xl mb-12 max-w-xl leading-relaxed font-medium">
                  Experience world-leading German-engineered hearing aids. AI-driven clarity, direct streaming, and invisible options. Book your{" "}
                  <span className="text-[#184A99] font-bold">Free Clinical Trial</span> at Insono clinics near you.
                </p>
                ...
                <div className="t5-up d4 pt-8 border-t border-slate-100 opacity-60">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-6">Authorized Partner and Distributor</p>
              ...
              <div className="t5-scale hidden xl:flex flex-[1.2] justify-center relative py-10">
                ...
                <Image
                  src="/hero3.png"
                  alt="Siemens Signia German Hearing Aids"
                  width={480}
                  height={440}
              ...
              <div className="t5-up d4 w-full lg:w-[360px] xl:w-[380px] flex-shrink-0 pt-0">
                <div id="lead-form" className="bg-white rounded-[2.5rem] shadow-2xl p-10 text-slate-900 relative overflow-hidden border border-slate-50">
                  ...
                  <p className="text-slate-500 text-xs mb-8 leading-relaxed">Download the complete Siemens (Signia) 2026 price list instantly on WhatsApp.</p>
                  <LeadForm />
        ...
        <section className="max-w-6xl mx-auto px-6 py-32" id="models">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
            <div className="text-left">
              <h2 className="text-[10px] font-black text-[#184A99] uppercase tracking-[0.4em] mb-4">German Engineering</h2>
              <h3 className="text-5xl font-bold text-slate-900 tracking-tight">Top Siemens (Signia) Models</h3>
            </div>
            <p className="text-slate-500 max-w-sm font-medium leading-relaxed text-lg">
              Individually selected for superior speech clarity, modern styling, and long-term durability.
            </p>
          </div>
                ...
                <div className="flex-1 p-12 lg:p-20 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-5 mb-10">
                      ...
                      <span className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">#{p.rank} Choice · German Sound Quality</span>
                    </div>
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="mt-8 text-center">
              <PopupTrigger className="inline-flex items-center gap-3 bg-[#184A99] text-white px-10 py-5 rounded-2xl font-bold text-sm hover:bg-[#13366e] transition shadow-xl shadow-blue-100 uppercase tracking-widest">
                ...
                Download &amp; Compare Siemens Prices
              </PopupTrigger>
            </div>
          </div>
        </section>
                ...
                <div key={r.name} className="bg-slate-50 rounded-2xl border border-slate-100 p-5 flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400 mt-0.5">{r.location} · <span className="text-emerald-500 font-semibold">✓ Verified Partner</span></p>
                    </div>
                  </div>
                  <div className="flex gap-0.5">
                    {[1, 2, 3, 4, 5].map((s) => <span key={s} className="text-yellow-400 text-sm">★</span>)}
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="flex gap-6 justify-center text-xs font-black text-slate-400 uppercase tracking-widest mb-6">
              <Link href="/landing/siemens-hearing-aid/privacy" className="hover:text-[#184A99]">Privacy Policy</Link>
              <Link href="/landing/siemens-hearing-aid/terms" className="hover:text-[#184A99]">Terms of Use</Link>
            </div>
