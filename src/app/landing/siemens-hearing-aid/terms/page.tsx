    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link href="/landing/siemens-hearing-aid" className="text-sm font-bold text-blue-600 hover:underline">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 bg-white my-12 rounded-[2.5rem] shadow-sm border border-slate-200">
        ...
        <p className="text-slate-500 mb-8">Effective Date: September 17, 2025</p>
