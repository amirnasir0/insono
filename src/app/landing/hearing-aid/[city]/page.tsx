...
export default async function HearingAidCityPage({
  params,
}: {
    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-[#eaf5ff]">
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          .ha-up            { animation: ha-up    0.5s ease both; }
          .ha-up.d1         { animation-delay: 0.1s; }
          .ha-up.d2         { animation-delay: 0.2s; }
          .ha-up.d3         { animation-delay: 0.3s; }
          .ha-up.d4         { animation-delay: 0.4s; }
          .ha-left          { animation: ha-left  0.5s ease both; }
          .ha-scale         { animation: ha-scale 0.8s 0.5s ease both; }
        `
      }} />
      ...
      <div className="block md:hidden pb-20">
        ...
        <section className="bg-gradient-to-b from-[#eaf5ff] to-white relative overflow-hidden">
          <div className="px-4 pt-3 pb-10 relative z-10 text-center">
            ...
            <h1 className="ha-up text-[22px] font-black leading-[1.15] mb-5 tracking-tight">
            ...
            <div className="ha-up d1 relative w-full mb-5 flex flex-col items-center justify-center">
            ...
            <div className="ha-up d2 space-y-2.5 mb-6 text-left">
              {/* Bullet 1 */}
          ...
          <div className="max-w-6xl mx-auto px-6 pt-10">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="flex-[1.6] pt-8">
                <div className="ha-left hidden lg:inline-flex items-center gap-2 bg-[#184A99]/10 rounded-full px-5 py-2 text-[11px] font-bold text-[#184A99] mb-8 border border-[#184A99]/20">
                  <span className="w-2 h-2 bg-[#184A99] rounded-full animate-pulse" />
                  Authorized Partner · Expert Audiologists in {city}
                </div>

                <h1 className="ha-up d1 text-5xl lg:text-[52px] font-black leading-[1.15] mb-8 tracking-tight">
                  <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                    Hearing Aid Price in {city} 2026
                  </span>
                </h1>

                <p className="ha-up d2 text-slate-500 text-xl mb-12 max-w-xl leading-relaxed font-medium">
                ...
                <div className="ha-up d3 grid grid-cols-3 gap-8 pt-10 border-t border-slate-100 mb-12">
                  {[
                ...
                <div className="ha-up d4 pt-8 border-t border-slate-100 opacity-60">
              ...
              {/* Col 2: Hero image */}
              <div className="ha-scale hidden xl:flex flex-1 justify-center relative group py-20">
              ...
              {/* Col 3: Lead form */}
              <div className="ha-up d4 w-full lg:w-[380px] flex-shrink-0 pt-8">
        ...
        <section className="max-w-6xl mx-auto px-6 py-32" id="models">
          ...
          <div className="grid gap-12">
            {MODELS.map((p) => (
              <div
                key={p.rank}
                className="bg-white border border-slate-100 rounded-[4rem] overflow-hidden hover:shadow-[0_40px_80px_-30px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-transform duration-700 flex flex-col lg:flex-row group"
              >
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.4em]">
              © 2026 Insono Hearing · Hearing Aid Specialist · {city}
            </p>
          </div>
        </footer>
      </div>
