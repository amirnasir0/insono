...
export default function FAQAccordion({ city }: { city: string }) {
  ...
  const FAQS = [
    {
      q: `What is the price of Widex hearing aids in ${city}?`,
      a: `Widex hearing aids start from ₹19,500 and go up to ₹3,25,000 for the premium MOMENT series. We provide 0% EMI and exchange offers. Fill the form to get the latest Widex price list for ${city}.`,
    },
    {
    ...
    {
      q: `Is Widex MOMENT Sheer available in ${city}?`,
      a: `Yes, Insono is an authorized premium partner for Widex in ${city}. We have the entire MOMENT Sheer collection available for a free clinical trial.`,
    },
    {
    ...
    },
    {
      ...
      a: `Widex offers up to 4 years of international warranty. Insono provides additional after-sales support and free servicing at our ${city} center.`,
    },
    {
      q: `Do you offer home trials for Widex in ${city}?`,
      a: `Yes, we provide home hearing tests and trials of Widex hearing aids across ${city} for your convenience.`,
    },
  ];
