...
const REVIEWS_BASE = [
  { name: "Sanjeev Chadda",   initials: "SC", avatarColor: "bg-[#184A99]",    time: "2 weeks ago" },
  { name: "Mohit Jindal",     initials: "MJ", avatarColor: "bg-emerald-600",   time: "1 month ago" },
  { name: "Surinder Kaur",    initials: "SK", avatarColor: "bg-purple-600",    time: "3 months ago" },
  { name: "Rajiv Singla",     initials: "RS", avatarColor: "bg-rose-600",      time: "1 week ago" },
];
...
export default async function WidexCityPage({
  params,
}: {
  ...
  const REVIEWS = [
    {
      ...REVIEWS_BASE[0],
      location: city,
      text: `As a music teacher, I was very picky about sound quality. Widex MOMENT is the only aid that sounded natural to me. Thanks to Insono ${city} for the expert fitting.`,
    },
    {
      ...REVIEWS_BASE[1],
      location: city,
      text: `The AI features in Widex EVOKE are amazing. It automatically adjusts to different environments. Great experience at Insono ${city} clinic.`,
    },
    {
      ...REVIEWS_BASE[2],
      location: city,
      text: `I was looking for something invisible. Widex IIC was the perfect fit. Extremely happy with the professional service and the free trial period at Insono ${city}.`,
    },
    {
      ...REVIEWS_BASE[3],
      location: city,
      text: `Best price for Widex in ${city}. The team is very helpful and the after-sales support is genuine. Highly recommended for senior citizens.`,
    },
  ];
    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-[#eaf5ff]">
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          .wx-up            { animation: wx-up    0.5s ease both; }
          .wx-up.d1         { animation-delay: 0.1s; }
          .wx-up.d2         { animation-delay: 0.2s; }
          .wx-up.d3         { animation-delay: 0.3s; }
          .wx-up.d4         { animation-delay: 0.4s; }
          .wx-left          { animation: wx-left  0.5s ease both; }
          .wx-scale         { animation: wx-scale 0.8s 0.5s ease both; }
        `
      }} />
      ...
      <div className="block md:hidden pb-20">
        ...
        <section className="bg-gradient-to-b from-[#eaf5ff] to-white relative overflow-hidden">
          <div className="px-4 pt-3 pb-10 relative z-10 text-center">
            <h1 className="wx-up text-[22px] font-black leading-[1.15] mb-5 tracking-tight">
              <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                Widex Hearing Aids Price in {city} 2026
              </span>
            </h1>

            <div className="wx-up d1 relative w-full mb-5 flex flex-col items-center justify-center">
            ...
            <ul className="wx-up d2 space-y-3 mb-6 text-left">
              {[
        ...
        <section className="py-8 px-4 bg-white">
          <div className="text-center mb-5">
            <h2 className="text-lg font-black text-slate-900">Best Selling Widex Hearing Aids</h2>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.1)] border-t border-slate-100 custom-bottom-bar flex">
          <a
            href={`https://wa.me/916204260510?text=Hi, I want to chat with an audiologist about Widex hearing aids in ${city}`}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <div className="max-w-6xl mx-auto px-6 pt-10">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="flex-[1.6] pt-8">
                <div className="wx-left hidden lg:inline-flex items-center gap-2 bg-[#184A99]/10 rounded-full px-5 py-2 text-[11px] font-bold text-[#184A99] mb-8 border border-[#184A99]/20">
                  <span className="w-2 h-2 bg-[#184A99] rounded-full animate-pulse" />
                  Authorized Partner · Expert Audiologists in {city}
                </div>

                <h1 className="wx-up d1 text-5xl lg:text-[52px] font-black leading-[1.15] mb-8 text-[#0D2240] tracking-tight">
                  <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                    Widex Hearing Aids Price in {city} 2026
                  </span>
                </h1>

                <p className="wx-up d2 text-slate-500 text-xl mb-12 max-w-xl leading-relaxed font-medium">
                  Discover the{" "}
                ...
                <div className="wx-up d3 grid grid-cols-3 gap-8 pt-10 border-t border-slate-100 mb-12">
                  {[
                ...
                <div className="wx-up d4 pt-8 border-t border-slate-100 opacity-60">
              ...
              {/* Col 2: Hero image */}
              <div className="wx-scale hidden xl:flex flex-1 justify-center relative group py-20">
              ...
              {/* Col 3: Lead form */}
              <div className="wx-up d4 w-full lg:w-[380px] flex-shrink-0 pt-8">
        ...
        <section className="max-w-6xl mx-auto px-6 py-32" id="models">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
            <div className="text-left">
              ...
              <h3 className="text-5xl font-bold text-slate-900 tracking-tight">2026&apos;s Top Widex Models</h3>
            </div>
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.4em]">
              © 2026 Insono Hearing · Widex Specialist Center · {city}
            </p>
          </div>
        </footer>
      </div>
