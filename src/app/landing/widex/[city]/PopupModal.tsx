          ...
          >
            ...
            <div className="px-6 pt-5 pb-6">
              <div className="flex items-start gap-4 mb-5">
                <div className="flex-shrink-0 w-14 h-14 rounded-2xl overflow-hidden border border-slate-100 shadow-sm flex items-center justify-center bg-slate-50">
                  <Image src="/brands/widex.svg" alt="Widex" width={40} height={24} className="w-10 h-auto grayscale" />
                </div>
                <div>
                  ...
                  <h2 className="text-[18px] font-black text-[#0D2240] leading-tight">
                    Download Complete<br />Widex Price List 2026
                  </h2>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-4 mb-5 border border-slate-100">
                ...
                <ul className="space-y-2">
                  {[
                    "MOMENT Sheer, EVOKE, Magnify & Enjoy",
              ...
              <div className="flex items-center justify-center gap-4 mt-4">
                <Image src="/brands/widex.svg" alt="Widex" width={64} height={16} className="h-4 w-auto grayscale opacity-40" />
