...
export default function LeadForm({
  ...
  const { gclid, utm_source, utm_medium, utm_campaign, utm_term, utm_content } =
    useUtmParams({ utm_campaign: "lucknow-hindi-landing" });
    ...
    >
      ...
      <div className="relative">
        ...
        <input
          ...
          maxLength={10}
          minLength={10}
          placeholder="व्हाट्सएप / मोबाइल नंबर (WhatsApp)"
          required
      ...
      >
        <span className="relative z-10 flex items-center gap-2">
          {isMobile
            ...
            : compact
            ? "प्राइस लिस्ट और ऑफर पाएं"
            : "प्राइस लिस्ट और मुफ्त ट्रायल पाएं"}
