            ...
            <div className="px-6 pt-5 pb-6">
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  ...
                  <h2 className="text-[18px] font-black text-[#0D2240] leading-tight">
                    मुफ्त कान की जांच और<br />ट्रायल बुक करें
                  </h2>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-4 mb-5 border border-slate-100">
                ...
                <ul className="space-y-2">
                  {[
                    "सभी टॉप ब्रांड्स पर ₹31,500 तक की छूट",
                    "RCI सर्टिफाइड ऑडियोलॉजिस्ट द्वारा मुफ्त जांच",
                    "7 दिनों का फ्री होम ट्रायल (घर पर पहनकर देखें)",
                    "0% आसान मासिक किस्त (EMI) की सुविधा",
                  ].map((item) => (
