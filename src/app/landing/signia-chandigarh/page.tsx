    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-[#eaf5ff]">
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          .sc-up            { animation: sc-up    0.5s ease both; }
          .sc-up.d1         { animation-delay: 0.1s; }
          .sc-up.d2         { animation-delay: 0.2s; }
          .sc-up.d3         { animation-delay: 0.3s; }
          .sc-up.d4         { animation-delay: 0.4s; }
          .sc-left          { animation: sc-left  0.5s ease both; }
          .sc-scale         { animation: sc-scale 0.8s 0.5s ease both; }
        `
      }} />
      ...
      <div className="block md:hidden pb-20">
        ...
        <section className="bg-gradient-to-b from-[#eaf5ff] to-white relative overflow-hidden">
          <div className="px-4 pt-3 pb-10 relative z-10 text-center">
            <h1 className="sc-up text-[22px] font-black leading-[1.15] mb-5 tracking-tight">
            ...
            <div className="sc-up d1 relative w-full mb-5 flex flex-col items-center justify-center">
            ...
            <ul className="sc-up d2 space-y-3 mb-6 text-left">
              {[
          ...
          <div className="max-w-6xl mx-auto px-6 pt-10">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="flex-[1.6] pt-8">
                <div className="sc-left hidden lg:inline-flex items-center gap-2 bg-[#184A99]/10 rounded-full px-5 py-2 text-[11px] font-bold text-[#184A99] mb-8 border border-[#184A99]/20">
                  <span className="w-2 h-2 bg-[#184A99] rounded-full animate-pulse" />
                  Authorized Partner · Expert Audiologists in Chandigarh
                </div>

                <h1 className="sc-up d1 text-5xl lg:text-[52px] font-black leading-[1.15] mb-8 text-[#0D2240] tracking-tight">
                  <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                    Signia Digital Hearing Aids Price 2026
                  </span>
                </h1>

                <p className="sc-up d2 text-slate-500 text-xl mb-12 max-w-xl leading-relaxed font-medium">
                  Discover the{" "}
                ...
                <div className="sc-up d3 grid grid-cols-3 gap-8 pt-10 border-t border-slate-100 mb-12">
                  {[
                ...
                <div className="sc-up d4 pt-8 border-t border-slate-100 opacity-60">
              ...
              {/* Col 2: Hero image */}
              <div className="sc-scale hidden xl:flex flex-1 justify-center relative group py-20">
              ...
              {/* Col 3: Lead form */}
              <div className="sc-up d4 w-full lg:w-[380px] flex-shrink-0 pt-8">
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.4em]">
              © 2026 Insono Hearing · Signia Specialist Center · Chandigarh
            </p>
          </div>
        </footer>
      </div>
