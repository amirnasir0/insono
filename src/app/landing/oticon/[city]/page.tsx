...
const OTICON_MODELS = [
  {
    ...
    features: ["4D Sensor Technology", "BrainHearing Tech", "Direct Bluetooth", "Rechargeable"],
    channels: "64 Channels",
    style: "RIC",
    highlight: "World's first hearing aid using user intent sensors to support communication",
  },
  {
    rank: 2,
    badge: "Best Speech Clarity",
    badgeColor: "bg-emerald-600 text-white",
    title: "Oticon Real 1",
    brand: "Oticon",
    brandLogo: "/brands/oticon.svg",
    image: "/lp/oticon2.png",
    features: ["RealSound Technology", "Wind & Handling Stabilizer", "Universal Connectivity", "Rechargeable"],
    channels: "64 Channels",
    style: "RIC",
    highlight: "Unprecedented clarity and comfort in windy and noisy environments",
  },
  {
    rank: 3,
    badge: "Best Seller",
    ...
    brand: "Oticon",
    brandLogo: "/brands/oticon.svg",
    image: "/lp/oticon3.png",
    features: ["Deep Neural Network", "MoreSound Intelligence", "Direct Streaming", "All-day Rechargeable"],
    channels: "64 Channels",
    style: "RIC",
    highlight: "Trained with 12 million real-life sound scenes for maximum brain support",
  },
  {
    rank: 4,
    badge: "Discreet Custom",
    badgeColor: "bg-rose-600 text-white",
    title: "Oticon Own",
    brand: "Oticon",
    brandLogo: "/brands/oticon.svg",
    image: "/lp/oticon4.png",
    features: ["Invisible-in-canal (IIC)", "Custom Tailored Fit", "BrainHearing Tech", "Clear Speech"],
    channels: "48 Channels",
    style: "IIC/CIC",
    highlight: "Discreet design that fits fully in the ear canal while delivering high performance",
  },
  {
    rank: 5,
    badge: "Great Value",
    ...
    brandLogo: "/brands/oticon.svg",
    image: "/lp/oticon1.png",
    features: ["OpenSound Navigator", "Direct Streaming", "Rechargeable Options", "Clear Sound"],
    channels: "48 Channels",
    style: "BTE/RIC",
    highlight: "Experience open sound paradigm at a very affordable price point",
  },
];
...
const REVIEWS_BASE = [
  { name: "Anil Sharma", initials: "AS", avatarColor: "bg-[#184A99]", time: "2 weeks ago" },
  { name: "Harish Verma", initials: "HV", avatarColor: "bg-emerald-600", time: "1 month ago" },
  { name: "Kiran Malhotra", initials: "KM", avatarColor: "bg-purple-600", time: "3 months ago" },
  { name: "Raman Preet", initials: "RP", avatarColor: "bg-rose-600", time: "1 week ago" },
];
...
export default async function OticonCityPage({
  params,
}: {
  ...
  const REVIEWS = [
    {
      ...REVIEWS_BASE[0],
      location: city,
      text: `Using Oticon Intent now. The 4D sensor technology is incredible—it adapts to where I'm looking and listening. Fantastic guidance by Insono team in ${city}.`,
    },
    {
      ...REVIEWS_BASE[1],
      location: city,
      text: "The sound from Oticon Real is so natural, especially outdoors where wind noise used to be a major issue. Highly recommend the free clinic demo.",
    },
    {
      ...REVIEWS_BASE[2],
      location: city,
      text: `Got Oticon Own custom aids for my mother at Insono ${city}. Completely invisible and she says the speech clarity is perfect. Home trials made it very convenient.`,
    },
    {
      ...REVIEWS_BASE[3],
      location: city,
      text: `Best rates for Oticon in ${city}. Original products with official warranty. The free consultation was extremely thorough.`,
    },
  ];
    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-[#eaf5ff]">
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          .ot-up            { animation: ot-up    0.5s ease both; }
          .ot-up.d1         { animation-delay: 0.1s; }
          .ot-up.d2         { animation-delay: 0.2s; }
          .ot-up.d3         { animation-delay: 0.3s; }
          .ot-up.d4         { animation-delay: 0.4s; }
          .ot-left          { animation: ot-left  0.5s ease both; }
          .ot-scale         { animation: ot-scale 0.8s 0.5s ease both; }
        `
      }} />
      ...
      <div className="block md:hidden pb-20">
        ...
        <section className="bg-gradient-to-b from-[#eaf5ff] to-white relative overflow-hidden">
          <div className="px-4 pt-3 pb-10 relative z-10 text-center">
            <h1 className="ot-up text-[22px] font-black leading-[1.15] mb-5 tracking-tight">
              <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                Oticon Hearing Aids Price in {city} 2026
              </span>
            </h1>

            <div className="ot-up d1 relative w-full mb-5 flex flex-col items-center justify-center">
              <div className="absolute w-[140px] h-[140px] bg-[#184A99]/8 rounded-full blur-[40px]" />
              <Image
                src="/lp/oticon1.png"
                alt="Oticon Digital Hearing Aid"
                width={180}
                height={180}
            ...
            <ul className="ot-up d2 space-y-3 mb-6 text-left">
              {[
                { icon: "🧠", text: "BrainHearing™ Sound Technology" },
                { icon: "🏥", text: `Free Hearing Test at ${city} Clinic` },
                { icon: "💰", text: "Save upto ₹35,000 on Oticon Aids" },
              ].map((b) => (
        ...
        <section className="py-8 px-4 bg-white">
          <div className="text-center mb-5">
            <h2 className="text-lg font-black text-slate-900">Best Selling Oticon Hearing Aids</h2>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.1)] border-t border-slate-100 custom-bottom-bar flex">
          <a
            href={`https://wa.me/916204260510?text=Hi, I want to chat with an audiologist about Oticon hearing aids in ${city}`}
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            ...
            <span className="text-[10px] font-black leading-none text-center">A Call Can Save ₹35,000</span>
          </a>
        </div>
      </div>
          ...
          <div className="max-w-6xl mx-auto px-6 pt-10">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="flex-[1.6] pt-8">
                <div className="ot-left hidden lg:inline-flex items-center gap-2 bg-[#184A99]/10 rounded-full px-5 py-2 text-[11px] font-bold text-[#184A99] mb-8 border border-[#184A99]/20">
                  <span className="w-2 h-2 bg-[#184A99] rounded-full animate-pulse" />
                  Authorized Partner · Expert Audiologists in {city}
                </div>

                <h1 className="ot-up d1 text-5xl lg:text-[52px] font-black leading-[1.15] mb-8 text-[#0D2240] tracking-tight">
                  <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                    Oticon Hearing Aids Price in {city} 2026
                  </span>
                </h1>

                <p className="ot-up d2 text-slate-500 text-xl mb-12 max-w-xl leading-relaxed font-medium">
                  Discover the{" "}
                ...
                <div className="ot-up d3 grid grid-cols-3 gap-8 pt-10 border-t border-slate-100 mb-12">
                  {[
                    { icon: <Users className="w-6 h-6" />, label: "1 Lakh+", sub: "Happy Customers" },
                    { icon: <MapPin className="w-6 h-6" />, label: "10+",     sub: "Clinics Across India" },
                    { icon: <Stethoscope className="w-6 h-6" />, label: "70+", sub: "Audiologists" },
                  ].map((s) => (
                    <div key={s.label}>
                ...
                <div className="ot-up d4 pt-8 border-t border-slate-100 opacity-60">
              ...
              {/* Col 2: Hero image */}
              <div className="ot-scale hidden xl:flex flex-1 justify-center relative group py-20">
                ...
                <Image
                  src="/lp/oticon1.png"
                  alt="Premium Oticon Hearing Aids"
                  width={500}
                  height={500}
                  sizes="500px"
              ...
              {/* Col 3: Lead form */}
              <div className="ot-up d4 w-full lg:w-[380px] flex-shrink-0 pt-8">
                <div id="lead-form" className="bg-white rounded-[2.5rem] shadow-2xl p-10 text-slate-900 relative overflow-hidden border border-slate-50">
                  ...
                  <h2 className="text-2xl font-bold mb-3 pt-4 text-[#0D2240]">Download Oticon Prices &amp; Claim Free Trial</h2>
                  <p className="text-slate-500 text-xs mb-8 leading-relaxed">Get the full 2026 Oticon Price List instantly on WhatsApp.</p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-32" id="models">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
            <div className="text-left">
              ...
              <h3 className="text-5xl font-bold text-slate-900 tracking-tight">2026&apos;s Top Oticon Models</h3>
            </div>
        ...
        <footer className="py-20 border-t border-slate-100 text-center bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-[11px] text-slate-400 font-bold uppercase tracking-[0.4em]">
              © 2026 Insono Hearing · Oticon Specialist Center · {city}
            </p>
          </div>
        </footer>
      </div>

      <PopupModal city={city} citySlug={citySlug} />
    </div>
  );
}
