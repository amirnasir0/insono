...
export default function LeadForm({
  ...
  return (
    ...
    >
      ...
      {/* UTM tracking */}
      <input type="hidden" name="utm_source" value={isMobile ? "hearing-aid-chandigarh-mobile" : "hearing-aid-chandigarh-landing"} />
      <input type="hidden" name="utm_medium" value={isMobile ? "Mobile" : "google-ads"} />
      <input type="hidden" name="utm_campaign" value="hearing-aid-chandigarh-mixed" />
