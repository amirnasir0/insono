  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-[#eaf5ff]">
      <style dangerouslySetInnerHTML={{
        ...
        @keyframes hc-scaleIn {
          from { opacity: 0; transform: scale(0.95); }
          to { opacity: 1; transform: scale(1); }
        }
        .hc-fade-up    { animation: hc-fadeUp  0.5s ease both; }
        .hc-fade-up-d1 { animation: hc-fadeUp  0.5s 0.1s ease both; }
        .hc-fade-up-d2 { animation: hc-fadeUp  0.5s 0.2s ease both; }
        .hc-fade-up-d3 { animation: hc-fadeUp  0.5s 0.3s ease both; }
        .hc-fade-up-d4 { animation: hc-fadeUp  0.5s 0.4s ease both; }
        .hc-scale-in   { animation: hc-scaleIn 0.6s 0.1s ease both; }
        .hc-scale-in-d4{ animation: hc-scaleIn 0.8s 0.5s ease both; }
      `}} />
      ...
      <div className="block md:hidden pb-20">
        ...
        <section className="bg-gradient-to-b from-[#eaf5ff] to-white relative overflow-hidden">
          <div className="px-4 pt-3 pb-10 relative z-10 text-center">
            <h1 className="hc-fade-up text-[22px] font-black leading-[1.15] mb-5 text-center tracking-tight">
            ...
            <div className="hc-scale-in relative w-full mb-5 flex flex-col items-center justify-center">
            ...
            <ul className="hc-fade-up-d2 space-y-3 mb-6 text-left">
              {[
            ...
            <div className="hc-fade-up-d3 w-full">
          ...
          <div className="max-w-6xl mx-auto px-6 pt-10">
            <div className="flex flex-col lg:flex-row gap-16 items-start">
              ...
              <div className="flex-[1.6] pt-8">
                <div className="hc-fade-up hidden lg:inline-flex items-center gap-2 bg-[#184A99]/10 rounded-full px-5 py-2 text-[11px] font-bold text-[#184A99] mb-8 border border-[#184A99]/20">
                  <span className="w-2 h-2 bg-[#184A99] rounded-full animate-pulse"></span>
                  Authorized Partner · Expert Audiologists in Chandigarh
                </div>

                <h1 className="hc-fade-up-d1 text-5xl lg:text-[52px] font-black leading-[1.15] mb-8 text-[#0D2240] tracking-tight">
                  <span className="bg-gradient-to-r from-[#E83D6D] via-[#0D2240] to-[#7C7C7C] bg-clip-text text-transparent">
                    Digital Hearing Aids Price 2026 Chandigarh
                  </span>
                </h1>

                <p className="hc-fade-up-d2 text-slate-500 text-xl mb-12 max-w-xl leading-relaxed font-medium">
                ...
                <div className="hc-fade-up-d3 grid grid-cols-3 gap-8 pt-10 border-t border-slate-100 mb-12">
                  <div>
              ...
              {/* Column 2: Image */}
              <div className="hc-scale-in-d4 hidden xl:flex flex-1 justify-center relative group py-20">
              ...
              {/* Column 3: Form */}
              <div className="hc-fade-up-d4 w-full lg:w-[380px] flex-shrink-0 pt-8">
