            ...
            <div className="px-6 pt-5 pb-6">
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  ...
                  <h2 className="text-[18px] font-black text-[#0D2240] leading-tight">
                    Download Top 5 Hearing Aid<br />Price List 2026
                  </h2>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-4 mb-5 border border-slate-100">
                ...
                <ul className="space-y-2">
                  {[
                    "All 5 models with 2026 prices & EMI breakdown",
                    "Signia, Phonak & Widex brand comparison",
                    "Invisible, rechargeable & AI model guide",
                    "Free trial booking — no obligation",
                  ].map((item) => (
              ...
              <div className="flex items-center justify-center gap-3 mt-4">
                ...
                <Image src="/brands/phonaklogo.svg" alt="Phonak" width={56} height={14} className="h-3.5 w-auto grayscale opacity-40" />
                <span className="text-[9px] text-slate-300">|</span>
