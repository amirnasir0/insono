...
export default function LeadForm({
  ...
  return (
    ...
    >
      ...
      {/* UTM tracking */}
      <input type="hidden" name="utm_source" value={isMobile ? "widex-chandigarh-mobile" : "widex-chandigarh-landing"} />
      <input type="hidden" name="utm_medium" value={isMobile ? "Mobile" : "google-ads"} />
      <input type="hidden" name="utm_campaign" value="widex-chandigarh-hearing-aids" />
