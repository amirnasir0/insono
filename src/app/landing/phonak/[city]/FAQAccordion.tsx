...
export default function FAQAccordion({ city }: { city: string }) {
  ...
  const FAQS = [
    {
      q: `What is the price of Phonak hearing aids in ${city}?`,
    ...
    {
      q: `Do you offer free Phonak trials in ${city}?`,
      a: `Yes, we offer a 100% free clinical trial of the latest Phonak models at our ${city} clinic so you can experience the sound quality before you buy.`,
    },
    {
      q: `Is Phonak Audeo Sphere available in ${city}?`,
      a: `Yes! Insono is an authorized partner for the latest Phonak Sphere AI technology in ${city}. You can book a live demo at our clinic today.`,
    },
    {
    ...
    },
    {
      ...
      a: `Phonak offers up to 4 years of international manufacturer warranty along with lifetime after-sales support at our ${city} center.`,
    },
    {
      q: `Do you provide home visits for Phonak trials in ${city}?`,
      a: `Yes, for senior citizens and those unable to travel, we provide home hearing tests and Phonak trials across ${city} and nearby areas.`,
    },
  ];
