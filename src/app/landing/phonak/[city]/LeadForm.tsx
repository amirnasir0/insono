...
export default function LeadForm({
  ...
  return (
    ...
    >
      ...
      <input type="hidden" name="utm_source" value={isMobile ? `phonak-${city}-mobile` : `phonak-${city}-landing`} />
      <input type="hidden" name="utm_medium" value={isMobile ? "Mobile" : "google-ads"} />
      <input type="hidden" name="utm_campaign" value={`phonak-${city}-hearing-aids`} />
