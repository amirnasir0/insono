    ...
    <div className="max-w-5xl mx-auto px-4 py-24">
      ...
      <section className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold leading-tight mb-4">
          How Much Do Hearing Aids Really Cost in India?
        </h1>
        <p className="text-gray-600 mb-6">
          Transparent pricing. No hidden charges. Compare brands, features, and
          savings.
        </p>
        <a href="#price-ranges" className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold shadow hover:bg-blue-700 transition">
          See Price Ranges
        </a>
      </section>
        ...
        {showPrice && (
          <div className="mt-6 text-center p-6 border rounded-lg bg-white shadow-sm">
            <p className="text-lg font-semibold mb-2">
              Estimated Price for {brand.charAt(0).toUpperCase() + brand.slice(1)} ({budget}):
            </p>
            <p className="text-blue-600 font-bold text-2xl">₹ {budget === "economy" ? "20,000 – 30,000" : budget === "mid" ? "40,000 – 70,000" : "80,000 – 1,50,000"}</p>
      ...
      <section className="text-center bg-blue-600 text-white rounded-xl p-10">
        ...
        <a href="/appointment" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold shadow hover:bg-gray-100 transition">
