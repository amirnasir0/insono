...
export default function ContactFormPage() {
  return (
    <main className="min-h-screen flex items-center justify-center mt-24  px-4 py-10">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl p-6 flex flex-col md:flex-row gap-6">
        {/* Left Side - Form */}
