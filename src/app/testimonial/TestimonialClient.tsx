...
const testi = [
  { name: "Bhagirathi Mistry", description: "I can't express how grateful I am for Insono hearing aids. My son's improved hearing has made a significant difference in his confidence and social interactions.", image: "/testi/review4.jpg" },
  { name: "Rajeev Varadarajan", description: "I purchased hearing Aids for my friend, and the outcomes are incredible. The enhanced clarity and comfort have made a significant positive impact on her daily life.", image: "/testi/Yoginder.jpeg" },
  { name: "Jagdish Arya", description: "Insono has truly exceeded our expectations. The hearing aids I purchased for my wife have not only improved her hearing but also seamlessly integrated into her daily routine.", image: "/testi/Gurmeet.jpeg" },
  { name: "Bhagirathi Mistry", description: "I can't express how grateful I am for Insono hearing aids. My son's improved hearing has made a significant difference in his confidence and social interactions.", image: "/testi/Balveer.jpeg" },
  { name: "Rajeev Varadarajan", description: "I purchased hearing Aids for my friend, and the outcomes are incredible. The enhanced clarity and comfort have made a significant positive impact on her daily life.", image: "/testi/review5.jpg" },
];
    ...
    <main className="bg-white text-gray-900 pt-24">
      <section className="py-16 max-w-7xl mx-auto px-4">
        <div className="container mx-auto px-4">
          ...
          <Slider dots infinite speed={800} slidesToShow={3} slidesToScroll={1} autoplay autoplaySpeed={3000} arrows responsive={[{ breakpoint: 1024, settings: { slidesToShow: 2 } }, { breakpoint: 768, settings: { slidesToShow: 1 } }]}>
            {testi.map((t, idx) => (
              <div key={idx} className="px-2">
                <div className="bg-white shadow-lg p-6 flex flex-col items-center h-full w-full rounded-xl">
                  <Image src={t.image} width={120} height={120} alt={t.name} className="rounded-full mb-4 w-24 h-24 object-cover" />
                  <h5 className="text-xl font-semibold">{t.name}</h5>
                  <div className="flex gap-1 mb-2">
                    {[...Array(5)].map((_, i) => <Image key={i} src="/star.jpg" width={20} height={20} alt="star" />)}
                  </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="relative w-full md:w-3/4 mx-auto aspect-video">
            <iframe className="w-full h-full rounded-lg shadow-lg" src={banners.url} title="Customer testimonial video" allowFullScreen />
          </div>
        </div>
      </section>
          ...
          {testimonials.map((t, idx) => (
            <div key={idx} className="flex flex-col items-center bg-gray-50 p-4 rounded-xl shadow-md h-full">
              <div className="w-full aspect-video">
                <iframe className="w-full h-full rounded-lg" src={t.url} title={t.name} allowFullScreen />
              </div>
