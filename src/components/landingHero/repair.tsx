...
export default function HeroSection() {
  ...
  return (
    <section className="overflow-x-hidden w-full mt-4">
      {/* ------------------ MOBILE LAYOUT ------------------ */}
      <div className="lg:hidden px-4 sm:px-6 md:px-8 pt-4 pb-12 flex flex-col gap-8 text-center">
        ...
        <p className="text-base md:text-lg lg:text-xl text-gray-700 mb-0 text-center">
          Fast repair for all brands. We fix sound, battery, receiver & physical
          damage using genuine parts with quick service.
        </p>
      ...
      <div className="hidden lg:flex max-w-6xl mx-auto pt-6 pb-16 gap-12 items-start">
        ...
        <div className="flex-1 space-y-6 text-left">
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-12">
            Fast repair for all brands. We fix sound, battery, receiver &
            physical damage using genuine parts with quick service.
          </p>
