      ...
      <div className="flex items-center justify-center bg-white p-4 sm:p-6 h-[180px] sm:h-[220px]">
        <Link href={`/product/${slug}`} className="block w-full text-center">
          <Image
            ...
            width={220}
            height={220}
            className="mx-auto object-contain cursor-pointer max-h-[160px] sm:max-h-[200px]"
          />
        </Link>
      </div>

      {/* Content */}
      <div className="px-3 sm:px-4 pb-4 sm:pb-5 flex flex-col justify-between flex-1">
        {/* Title */}
        <h3
          className={`${poppins.className} text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1 text-center`}
        >
